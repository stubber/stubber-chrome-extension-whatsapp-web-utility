...
// waitForElement("._ajv7._ajv8._ajvb", (targetDiv) => {

//wait for element with aria-label="Chats"
waitForElement("[aria-label='Chats']", (targetDiv) => {
  const toggleDiv = document.createElement("div");
  toggleDiv.classList.add("_ajv7", "_ajvb");

  const toggleButton = document.createElement("button");
  toggleButton.style.position = "relative";
  toggleButton.style.padding = "5px"; // Padding to ensure space around the SVG
  ...
  //get the parent of the targetDiv and then the parent of that and insert the toggleDiv before the targetDiv
  targetDiv.parentNode.parentNode.insertBefore(toggleDiv, targetDiv.parentNode);
});
